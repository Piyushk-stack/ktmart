...
import rice1 from '../../../pages/Grocery/riceandrice/rice1.jpg'
import rice2 from '../../../pages/Grocery/riceandrice/rice2.jpg'
import rice3 from '../../../pages/Grocery/riceandrice/rice3.jpg'
import rice4 from '../../../pages/Grocery/riceandrice/rice4.jpg'
import rice5 from '../../../pages/Grocery/riceandrice/rice5.jpg'
import rice6 from '../../../pages/Grocery/riceandrice/rice6.jpg'
import rice7 from '../../../pages/Grocery/riceandrice/rice7.png'
import rice8 from '../../../pages/Grocery/riceandrice/rice8.jpg'
...
const Rice = () => {
     ...
     const products = [
          { id: 1, name: "Heritage Popular Classic Basmati Rice", image: rice1, originalPrice: 139, discountedPrice: 88, discountPercent: 37 },
          { id: 2, name: "Heritage Basmathi Super Dubar Rice", image: rice2, originalPrice: 179, discountedPrice: 89.5, discountPercent: 50 },
          { id: 3, name: "India Gate Feast Rozzana Basmathi Rice", image: rice3, originalPrice: 118, discountedPrice: 110.8, discountPercent: 6 },
          { id: 4, name: "India Gate Tibar Basmathi Rice", image: rice4, originalPrice: 125, discountedPrice: 112, discountPercent: 50 },
          { id: 5, name: "Heritage Basmathi Royal Rice", image: rice5, originalPrice: 145, discountedPrice: 139, discountPercent: 4 },
          { id: 6, name: "India Gate Basmathi Rice Dubar", image: rice6, originalPrice: 151, discountedPrice: 145, discountPercent: 4 },
          { id: 7, name: "Sri Sri Tattva Basmati Rice", image: rice7, originalPrice: 157, discountedPrice: 150.7, discountPercent: 4 },
          { id: 8, name: "Unity Basmathi Rice", image: rice8, originalPrice: 166, discountedPrice: 156.48, discountPercent: 6 },
          // { id: 9, name: "SPAR SELECT MUSTARD SMALL", image: dry9, originalPrice: 175, discountedPrice: 168, discountPercent: 4 },
          // { id: 10, name: "Spar Select Methi 200G", image: dry10, originalPrice: 212, discountedPrice: 195.55, discountPercent: 8 },
          // { id: 11, name: "SPAR SELECT CINNAMON 50G", image: dry11, originalPrice: 252, discountedPrice: 209.1, discountPercent: 17 },
          // { id: 12, name: "Aashirvaad Chilli Powder Guntur And Byadagi", image: dry12, originalPrice: 900, discountedPrice: 680, discountPercent: 24 },
          ...
          <div className="px-2 sm:px-4 md:px-8 lg:px-20 mt-40 py-6">
               ...
               <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="flex-1">
                         {/* Banner */}
                         <span className="font-bold text-lg sm:text-2xl">Rice & Rice</span>
