...
import dry1 from '../../../pages/Grocery/dryfruits/dry1.webp'
import dry2 from '../../../pages/Grocery/dryfruits/dry2.webp'
import dry3 from '../../../pages/Grocery/dryfruits/dry3.webp'
import dry4 from '../../../pages/Grocery/dryfruits/dry4.webp'
import dry5 from '../../../pages/Grocery/dryfruits/dry5.webp'
import dry6 from '../../../pages/Grocery/dryfruits/dry6.webp'
import dry7 from '../../../pages/Grocery/dryfruits/dry7.webp'
import dry8 from '../../../pages/Grocery/dryfruits/dry8.webp'
...
const Dry1 = () => {
     ...
     const products = [
          { id: 1, name: "Almond California", image: dry1, originalPrice: 139, discountedPrice: 88, discountPercent: 37 },
          { id: 2, name: "Cashew W320", image: dry2, originalPrice: 179, discountedPrice: 89.5, discountPercent: 50 },
          { id: 3, name: "Walnut Premium", image: dry3, originalPrice: 118, discountedPrice: 110.8, discountPercent: 6 },
          { id: 4, name: "Pistachio / Pista Premium", image: dry4, originalPrice: 125, discountedPrice: 112, discountPercent: 50 },
          { id: 5, name: "Cashew W180", image: dry5, originalPrice: 145, discountedPrice: 139, discountPercent: 4 },
          { id: 6, name: "Pistachio / Pista Shell-Less", image: dry6, originalPrice: 151, discountedPrice: 145, discountPercent: 4 },
          { id: 7, name: "Mixed Nuts", image: dry7, originalPrice: 157, discountedPrice: 150.7, discountPercent: 4 },
          { id: 8, name: "Fried Chana / Roasted Gram With Skin", image: dry8, originalPrice: 166, discountedPrice: 156.48, discountPercent: 6 },
          ...
          <div className="px-2 sm:px-4 md:px-8 lg:px-20 mt-40 py-6">
               ...
               <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="flex-1">
                         {/* Banner */}
                         <span className="font-bold text-lg sm:text-2xl">Dry Fruits</span>
