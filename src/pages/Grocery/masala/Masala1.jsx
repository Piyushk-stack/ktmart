...
import mas1 from '../../../pages/Grocery/masala/mas1.webp'
import mas2 from '../../../pages/Grocery/masala/mas2.webp'
import mas3 from '../../../pages/Grocery/masala/mas3.webp'
import mas4 from '../../../pages/Grocery/masala/mas4.webp'
import mas5 from '../../../pages/Grocery/masala/mas5.webp'
import mas6 from '../../../pages/Grocery/masala/mas6.webp'
import mas7 from '../../../pages/Grocery/masala/mas7.webp'
import mas8 from '../../../pages/Grocery/masala/mas8.webp'
import mas9 from '../../../pages/Grocery/masala/mas9.webp'
import mas10 from '../../../pages/Grocery//masala/mas10.webp'
import mas11 from '../../../pages/Grocery//masala/mas11.webp'
import mas12 from '../../../pages/Grocery//masala/mas12.webp'
...
const Masala1 = () => {
     ...
     const products = [
          { id: 1, name: "Spar Select Jeera Whole 200G", image: mas1, originalPrice: 139, discountedPrice: 88, discountPercent: 37 },
          { id: 2, name: "Mothers recp gingr garlic paste pouch 200g", image: mas2, originalPrice: 179, discountedPrice: 89.5, discountPercent: 50 },
          { id: 3, name: "Spar Select Coriander 200G", image: mas3, originalPrice: 118, discountedPrice: 110.8, discountPercent: 6 },
          { id: 4, name: "SPAR SELECT JEERA WHOLE 100G", image: mas4, originalPrice: 125, discountedPrice: 112, discountPercent: 50 },
          { id: 5, name: "SPAR Select Mustard Bold", image: mas5, originalPrice: 145, discountedPrice: 139, discountPercent: 4 },
          { id: 6, name: "SPAR Select Methi", image: mas6, originalPrice: 151, discountedPrice: 145, discountPercent: 4 },
          { id: 7, name: "Spar Select Mustard Bold 200G", image: mas7, originalPrice: 157, discountedPrice: 150.7, discountPercent: 4 },
          { id: 8, name: "SPAR SELECT MUSTARD SMALL", image: mas8, originalPrice: 166, discountedPrice: 156.48, discountPercent: 6 },
          { id: 9, name: "SPAR SELECT MUSTARD SMALL", image: mas9, originalPrice: 175, discountedPrice: 168, discountPercent: 4 },
          { id: 10, name: "Spar Select Methi 200G", image: mas10, originalPrice: 212, discountedPrice: 195.55, discountPercent: 8 },
          ...
          <div className="px-2 sm:px-4 md:px-8 lg:px-20 mt-40 py-6">
               ...
               <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="flex-1">
                         {/* Banner */}
                         <span className="font-bold text-lg sm:text-2xl">Masale</span>
