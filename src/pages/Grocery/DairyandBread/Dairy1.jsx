...
import day1 from '../../../pages/Grocery/DairyandBread/day1.webp'
import day2 from '../../../pages/Grocery/DairyandBread/day2.webp'
import day3 from '../../../pages/Grocery/DairyandBread/day3.webp'
import day4 from '../../../pages/Grocery/DairyandBread/day4.webp'
import day5 from '../../../pages/Grocery/DairyandBread/day5.webp'
import day6 from '../../../pages/Grocery/DairyandBread/day6.webp'
import day7 from '../../../pages/Grocery/DairyandBread/day7.webp'
import day8 from '../../../pages/Grocery/DairyandBread/day8.webp'
import day9 from '../../../pages/Grocery/DairyandBread/day9.webp'
import day10 from '../../../pages/Grocery/DairyandBread/day10.webp'
// import day11 from '../../../pages/Grocery//masala/mas11.webp'
// import day12 from '../../../pages/Grocery//masala/mas12.webp'
...
const Dairy1 = () => {
     ...
     const products = [
          { id: 1, name: "NANDINI PASTEURISED TONED MILK 500ML", image: day1, originalPrice: 139, discountedPrice: 88, discountPercent: 37 },
          { id: 2, name: "NANDINI FRESH CURD 500GM", image: day2, originalPrice: 179, discountedPrice: 89.5, discountPercent: 50 },
          { id: 3, name: "Milky Mist Paneer", image: day3, originalPrice: 118, discountedPrice: 110.8, discountPercent: 6 },
          { id: 4, name: "NANDINI GOODLIFE MILK 1L", image: day4, originalPrice: 125, discountedPrice: 112, discountPercent: 50 },
          { id: 5, name: "NANDINI GOODLIFE MILK 500GMS", image: day5, originalPrice: 145, discountedPrice: 139, discountPercent: 4 },
          { id: 6, name: "MILK MAID 380G TIN", image: day6, originalPrice: 151, discountedPrice: 145, discountPercent: 4 },
          { id: 7, name: "AMUL BUTTER 500GMS", image: day7, originalPrice: 157, discountedPrice: 150.7, discountPercent: 4 },
          { id: 8, name: "AMUL TAAZA DOUBLE TONED 1 LTR", image: day8, originalPrice: 166, discountedPrice: 156.48, discountPercent: 6 },
          { id: 9, name: "Amul Cheese Slices (Pack of 5)", image: day9, originalPrice: 175, discountedPrice: 168, discountPercent: 4 },
          { id: 10, name: "Milky Mist Cooking Butter", image: day10, originalPrice: 212, discountedPrice: 195.55, discountPercent: 8 },
          // { id: 11, name: "SPAR SELECT CINNAMON 50G", image: mas11, originalPrice: 252, discountedPrice: 209.1, discountPercent: 17 },
          // { id: 12, name: "Aashirvaad Chilli Powder Guntur And Byadagi", image: mas12, originalPrice: 900, discountedPrice: 680, discountPercent: 24 },
          ...
          <div className="px-2 sm:px-4 md:px-8 lg:px-20 mt-40 py-6">
               ...
               <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="flex-1">
                         {/* Banner */}
                         <span className="font-bold text-lg sm:text-2xl">Dairy & Bread</span>
